const AuthorTags = (): JSX.Element => (
  <div className="flex items-center space-x-2 text-white">
    ...
    <span className="bg-purple-100 text-purple-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-purple-900 dark:text-purple-300">#tag</span>
    ...
    <span className="bg-red-100 text-red-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-red-900 dark:text-red-300">#tag</span>
  </div>
);
